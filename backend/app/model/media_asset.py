...
from app.model.enums import MediaType, RetentionStatus
...
class MediaAsset(Base):
    ...
    animal_id: Mapped[Optional[str]] = mapped_column(
        String(20), ForeignKey("animals.animal_id"), nullable=True
    )
    muzzle_template_id: Mapped[Optional[uuid.UUID]] = mapped_column(
    ...
    media_type: Mapped[MediaType] = mapped_column(
        SAEnum(MediaType, name="media_type"), nullable=False, default=MediaType.MUZZLE_PHOTO
    )
    ...
    muzzle_template: Mapped[Optional["MuzzleTemplate"]] = relationship(back_populates="source_media")
    uploaded_by_user: Mapped[Optional["User"]] = relationship(back_populates="media_assets_uploaded")
